                    ...
                    if(!preg_match("^[0-9]{11}^", $email_mobile)){
                        ...
                        if($mob > 11 || $mob < 11){
                            ...
                            if(DB::query('SELECT mobile FROM users WHERE mobile=:mobile', array(':mobile'=>$email_mobile))){
                                ...
                                $loadFromUser->create('profile', array('userId'=>$user_id, 'birthday'=>$birth, 'firstName'=>$first_name, 'lastName'=>$last_name, 'profilePic'=>'assets/image/defaultProfile.png','profileCover'=>'assets/image/defaultCover.png', 'gender'=>$upgen));
...
<html>
    ...
    <body>
            ...
            <form action="sign.php" method="post">
               <div class="sign-in-form">
                    <div class="mobile-input">
                        ...
                        <input type="text" name="in-email-mobile" id="email-mobile" class="inpuut-text-field">
                    </div>
                    <div class="password-input">
                        <div style="font-size: 12px; padding-bottom: 5px;">Password</div>
                        <input type="password" name="in-pass" id="in-password" class="inpuut-text-field">
                    ...
                    <div class="sign-up-form">
                      ...
                      <div class="sign-up-birthday">
                          ...
                          <div class="form-birthday">
                              <select class="select-body" name="birth-day" id="days"></select>
                              <select class="select-body" name="birth-month" id="months"></select>
                              <select class="select-body" name="birth-year" id="years"></select>
                          </div>
                          <div class="gender-wrap">
                              <input type="radio" name="gen" value="female" class="m0">
                              <label for="fem" class="gender">Female</label>

                              <input type="radio" name="gen" value="male" class="m0">
                              <label for="male" class="gender">Male</label>
                          </div>
                          <div class="term">
                              By clicking Sign Up, you agree to our terms, Data policy and Cookie policy. You mayt recive SMS notification from us and can opt out at any time.
                          </div>

                          <input type="submit" name="" value="Sign Up" class="sign-up">
                      </div>
                    </div>
                  </form>
            </div>
        ...
        <script>
            ...
            function updateNumberofDays(argument) {
              // body...
              $('#days').html('');
              month = $('#months').val();
              year = $('#years').val();
